...
export const equipmentsValues = {
    deviceCategory: ['Kannettava', 'Tv', 'Puhelin','Laite 1', 'Laite 2', 'Kamera'],
    manufacture: ['Lenovo', 'Asus', 'Lg', 'Valmistaja 1','Valmistaja 2','Microsoft'],
    model: ['Malli 1', 'Malli 2', 'Abc 123', 'Qwerty'],
    info: ['Kiva kone', 'HaHaa', 'Info 1', 'Info 2', 'OLED'],
    loanStatus: [true, false],
};
